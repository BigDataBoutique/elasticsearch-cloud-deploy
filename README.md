...
***Note:*** This branch supports Elasticsearch 6.x only and was currently tested only for AWS deployment. For other Elasticsearch versions and deployments see [elasticsearch-5.x](https://github.com/BigDataBoutique/elasticsearch-cloud-deploy/tree/elasticsearch-5.x) and [elasticsearch-6.x](https://github.com/BigDataBoutique/elasticsearch-cloud-deploy/tree/elasticsearch-6.x) branches.
...
* Client node with Kibana, Grafana and authenticated Elasticsearch access
